...
FALCON-Phase integrates PacBio long-read assemblies with [Phase Genomics](https://phasegenomics.com)  Hi-C data to create phased, diploid, chromosome-scale scaffolds.
